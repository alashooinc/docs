...
To avoid failed settlements, **CNHO requires a real test transaction** in the form of an **initial CNHO subscription**.
...
2. **Add and Verify a Bank Account that supports CNH**\
   ([See Bank Verification Guide](https://docs.cnho.io/bank))

Only then can you proceed with Initialization.

---

### 💰 Step-by-Step: Complete Initialization via CNHO Subscription
...
- Please follow the official CNHO-CNH **Acquiring** Guide:\
  👉 [Link to Acquiring Instructions (CNHO-CNH)](#)
