...
description: "For Offshore RMB (CNH) Transactions"
---

Once you’ve successfully passed identity (KYC) verification, you must verify a **bank account that supports offshore RMB (CNH)** to use fiat on/off ramp services such as deposits, transfers, and withdrawals.
...
- After login, navigate to **My Bank → Add New Bank**
