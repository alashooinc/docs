...
3. **Navigate to the KYC Section**
   - After logging in, go to your **Account Dashboard** and click on **"Verificaton"** in the dashboard.
   - Select your account type: **Fiat Account** and **Exchange Account** (both require KYC and share the same KYC credentials).
